...
class Controller(Node):
    ...
    def click_callback(self):
        ...
        if self.point[1] < (self.window_size.shape[0]/2) and self.point[0] > (self.window_size.shape[1]*0.3) and self.point[0] < (self.window_size.shape[1]*0.7):
            msg.linear.x = 1.0
        elif self.point[1] >= (self.window_size.shape[0]/2) and self.point[0] > (self.window_size.shape[1]*0.3) and self.point[0] < (self.window_size.shape[1]*0.7):
            msg.linear.x = -1.0
        elif self.point[0] <= (self.window_size.shape[1]*0.3):
            msg.angular.z = 0.5
        elif self.point[0] >= (self.window_size.shape[1]*0.7):
            msg.angular.z = -0.5
